...
inventory_width =
  window_padding_x + sprite_padding_x * (inventory_columns + 1) + slot_sprite_w * (inventory_columns - 1);
inventory_height = window_padding_y + sprite_padding_y * (inventory_rows + 1) + slot_sprite_h * (inventory_rows - 1);
