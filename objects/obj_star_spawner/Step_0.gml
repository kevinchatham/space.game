var _x_min = obj_ship.x - obj_space_camera.view_width;
var _x_max = obj_ship.x + obj_space_camera.view_width;
var _y_min = obj_ship.y - obj_space_camera.view_height;
var _y_max = obj_ship.y + obj_space_camera.view_height;
...
for (var _i = 0; _i < _respawn_count; _i++) {
  ...
  if (_new_star != noone) {
    show_debug_message("Spawned star at x: " + string(_x) + ", y: " + string(_y));
  }
}
